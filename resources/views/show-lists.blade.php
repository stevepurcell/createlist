...
<div class="font-sans text-gray-900 antialiased">
    <div class="flex flex-col sm:justify-center items-center pt-5 pb-5">
        <h2 class="font-bold text-2xl">Show List Component</h2>
        <a href="{{ route('song-list-create') }}">New List</a>
        <div class="w-full sm:max-w-2xl mt-6 mb-6 px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
            @livewire('show-lists')
        </div>

        {{-- <a href="{{ route('show-lists') }}">Show Lists</a> --}}
    </div>
</div>
@livewireScripts
